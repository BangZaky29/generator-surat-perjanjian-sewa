...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'perjanjian-sewa'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug = 'perjanjian-sewa') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug = 'perjanjian-sewa') => {
    try {
